...
const Live = () => {
    ...
    return (
        <aside ref={drawerRef} className={`${ bottomDrawer ? 'translate-y-0' : 'translate-y-5/4'} left-0 transition-transform transition-200 bottom-drawer bg-neutral flex flex-row justify-center items-end gap-16 py-6 xl:px-12 md:px-8 sm:px-4 px-2 text-secondary`}>
