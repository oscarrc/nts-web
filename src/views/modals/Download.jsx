                    ...
                    <div className="flex w-full items-center justify-center">
                        <div className="dropdown m-4 flex-1">
                            ...
                            <ul tabIndex="0" className="dropdown-content menu menu-info p-2 shadow rounded p-0 -top-px w-full">
                                <li><a href={`https://github.com/oscarrc/nts-web/releases/latest/download/NTS-web_win-x64-${import.meta.env.VITE_APP_VERSION}.exe`} target="_BLANK" rel="noreferrer noopener">Installer 64 bits</a></li>
                                <li><a href={`https://github.com/oscarrc/nts-web/releases/latest/download/NTS-web_win-ia32-${import.meta.env.VITE_APP_VERSION}.exe`} target="_BLANK" rel="noreferrer noopener">Installer 32 bits</a></li>
                                <li><a href={`https://github.com/oscarrc/nts-web/releases/latest/download/NTS-web_win-x64-${import.meta.env.VITE_APP_VERSION}_portable.exe`} target="_BLANK" rel="noreferrer noopener">Portable 64 bits</a></li>
                                <li><a href={`https://github.com/oscarrc/nts-web/releases/latest/download/NTS-web_win-ia32-${import.meta.env.VITE_APP_VERSION}_portable.exe`} target="_BLANK" rel="noreferrer noopener">Portable 32 bits</a></li>
                            </ul>
                        </div>                            
                        <div className="dropdown m-4 flex-1">                                
                            ...
                            <ul tabIndex="0" className="dropdown-content menu menu-secondary p-2 shadow rounded p-0 -top-px w-full">
                                <li><a href={`https://github.com/oscarrc/nts-web/releases/latest/download/NTS-web_linux-amd64-${import.meta.env.VITE_APP_VERSION}.deb`} target="_BLANK" rel="noreferrer noopener">Deb 64 bits</a></li>
                                <li><a href={`https://github.com/oscarrc/nts-web/releases/latest/download/NTS-web_linux-x86_64-${import.meta.env.VITE_APP_VERSION}.rpm`} target="_BLANK" rel="noreferrer noopener">RPM 64 bits</a></li>
                                <li><a href={`https://github.com/oscarrc/nts-web/releases/latest/download/NTS-web_linux-x86_64-${import.meta.env.VITE_APP_VERSION}.AppImage`} target="_BLANK" rel="noreferrer noopener">AppImage</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
