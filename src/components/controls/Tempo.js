        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="form-control">
                <label className="cursor-pointer label py-0">
                    ...
                    <input aria-label="Metronome sound" type="checkbox" className="toggle toggle-secondary checked:toggle-accent focus:border-none border-none focus:ring-0 outline-none toggle-xs" />
                </label>
            </div>
        </div>
    )
