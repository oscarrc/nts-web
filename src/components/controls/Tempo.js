const Tempo = ({ tempo, onChange }) => {
    ...
    return (
        <div className="flex gap-1 h-8 w-36">            
            ...
            <input onChange={ (e) => setValue(e.target.value) } type="text" value={ tempo } className="bg-neutral w-full text-center bg-grid font-sevenSegment text-2xl text-accent outline outline-base-100 outline-offset-1 outline-1 px-2" />           
