...
const Footer = () => {
    return (
        <footer className="footer items-center justify-items-center	 md:justify-between p-2 gap-y-4">
            <p className="grid-flow-col items-center">Made with <FaHeart className="text-error h-3 w-3 inline" /> by <a href="https://oscarrc.me" rel="noreferrer" target="_BLANK">Oscar R.C.</a></p>
