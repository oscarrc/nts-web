    ...
    return (
        <section className="sticky md:relative flex flex-col gap-4 flex-1 h-full min-h-[235px] mx-4 my-2">
            ...
            <div className="grid grid-cols-8 gap-4 justify-between">
                ...
                <div className="flex col-span-2 gap-1">
                    <button onClick={removeBar} aria-label="Remove step" className="flex-1 btn btn-ghost btn-pushable border-secondary text-secondary btn-xs"> <BsDash className="h-4 w-4" /> </button>
                    <button onClick={addBar} aria-label="Add step" className="flex-1 btn btn-ghost btn-pushable border-secondary text-secondary btn-xs"> <BsPlus className="h-4 w-4" /> </button>
                </div>
